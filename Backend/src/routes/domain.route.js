...
import {checkCloudflareValidity, checkServerValidity, clearCacheOfDomain, createDomain, createDomainInCloudflare, createDomainInServer, deleteDomain, deleteDomainInCloudflare, deleteDomainInServer, getDomain, getDomains} from '../controllers/domain.controller.js'
...
domainRouter.route("/domain-name/delete-domain-cloudflare/:id").delete(deleteDomainInCloudflare)
domainRouter.route("/domain-name/delete-domain-server/:id").delete(deleteDomainInServer)
